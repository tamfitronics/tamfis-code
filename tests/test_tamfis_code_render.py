...
class StreamRendererTests(unittest.TestCase):
    ...
    def test_running_status_keeps_live_input_affordance_visible(self):
        ...
        try:
            ...
            output = console.file.getvalue()
            # The Ctrl+Y queue-next control key was replaced by a real,
            # persistent input box (a prompt_toolkit-owned editable follow-up
            # line) -- see render.py's _build_status comment.
