...
class LoadConfigTests(unittest.TestCase):
    def setUp(self):
        ...
        self._env_workspace_roots = os.environ.pop("TAMFIS_CODE_WORKSPACE_ROOTS", None)
    ...
    def tearDown(self):
        ...
        if self._env_workspace_roots is not None:
            os.environ["TAMFIS_CODE_WORKSPACE_ROOTS"] = self._env_workspace_roots
    ...
    def test_workspace_roots_load_from_user_config(self):
        config_module.USER_CONFIG_PATH.write_text(
            'workspace_roots = ["/home/project-a", "/home/project-b"]\n'
        )
        cfg = config_module.load_config()
        self.assertEqual(cfg.workspace_roots, ["/home/project-a", "/home/project-b"])

    def test_workspace_roots_load_from_environment(self):
        previous = os.environ.get("TAMFIS_CODE_WORKSPACE_ROOTS")
        os.environ["TAMFIS_CODE_WORKSPACE_ROOTS"] = os.pathsep.join(("/home/project-a", "/home/project-b"))
        try:
            cfg = config_module.load_config()
            self.assertEqual(cfg.workspace_roots, ["/home/project-a", "/home/project-b"])
        finally:
            if previous is None:
                os.environ.pop("TAMFIS_CODE_WORKSPACE_ROOTS", None)
            else:
                os.environ["TAMFIS_CODE_WORKSPACE_ROOTS"] = previous
